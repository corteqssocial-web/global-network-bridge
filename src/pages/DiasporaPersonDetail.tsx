...
import {
  ...
  Linkedin, FileText, Coffee, Bell, ExternalLink, Sparkles
} from "lucide-react";
      ...
      <main className="pt-20 pb-16">
        <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="pt-8 p-6 flex flex-col sm:flex-row gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  ...
                  <Button size="sm" variant="outline" className="gap-1"><UserPlus className="h-3.5 w-3.5" /> Takip Et</Button>
                  {person.cafeName && (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            ...
            <Stat icon={MessageSquare} label="WA Grup" value={person.whatsappGroups.length} />
          </div>
          ...
          <Tabs defaultValue="about">
            <TabsList className="flex flex-wrap h-auto bg-muted/40 p-1 rounded-xl">
              ...
              <TabsTrigger value="coupons" className="gap-1.5"><Tag className="h-3.5 w-3.5" /> Kuponlar</TabsTrigger>
            ...
            <div className="mt-4 space-y-4">
                ...
                <SectionCard>
                  ...
                  {person.cvAvailable && (
                    <div className="mt-4 pt-4 border-t border-border flex items-center justify-between">
                      ...
                      <Button size="sm" variant="outline">CV İste</Button>
                    </div>
                  )}
                </SectionCard>
              </TabsContent>
              ...
              <TabsContent value="requests" className="m-0">
                <SectionCard>
                  ...
                  <ul className="space-y-2">
                    {person.serviceRequests.map((r, i) => (
              ...
              <TabsContent value="whatsapp" className="m-0">
                <SectionCard>
                  <div className="flex items-center gap-2 mb-3">
                    <h3 className="font-bold">WhatsApp Grupları</h3>
                    <Badge variant="outline" className="text-[10px]">Demo</Badge>
                  </div>
                  <ul className="space-y-2">
              ...
              <TabsContent value="coupons" className="m-0">
                <SectionCard>
                  <div className="flex items-center gap-2 mb-3">
                    <h3 className="font-bold">Kullandığı / Kaydettiği Kuponlar</h3>
                    <Badge variant="outline" className="text-[10px]">Demo</Badge>
                  </div>
                  <ul className="grid sm:grid-cols-2 gap-2">
                    {person.coupons.map((c, i) => (
                      <li key={i} className="p-3 rounded-lg border border-border">
                        <div className="flex items-center justify-between">
                          <Badge>{c.brand}</Badge>
                          <span className="text-[11px] text-muted-foreground">son: {c.expires}</span>
                        </div>
                        <div className="text-sm font-semibold mt-1.5">{c.title}</div>
                      </li>
                    ))}
                  </ul>
                </SectionCard>
